    ...
    <div className={`w-full relative pt-12 ${className}`}>
      ...
      >
        <div className="flex flex-col items-left w-full md:w-11/12 mx-10 mt-[5%] md:mt-[3%] md:mx-[15%]">
          <h1 className="w-1/2 font-bold font-roboto text-3xl md:text-[64px] mt-4 md:mt-8 md:mb-3 text-primeYellow uppercase hover-custom-filter">
            {title}
          </h1>
          <div className="w-1/2 md:w-1/4 h-1 bg-primeGreen mb-1" />
          <h3 className="text-lg md:text-3xl mb-3 font-semibold text-lightGray md:mt-0">
            {subtitle}
          </h3>
        </div>
      </div>
