...
const ContactInfo = () => {
    return (
        <div className="w-2/3 flex flex-col mx-auto animate__animated animate__fadeIn">
            <div className="flex justify-center items-center gap-1 md:gap-4 mb-4 animate__animated animate__fadeInUp">
                <h2 className="text-2xl md:text-3xl font-semibold text-darkGray uppercase font-roboto">
                    Podaci za Identifikaciju
                </h2>
                <img src={info} alt="info icon" className="w-8 md:w-9 animate__animated animate__bounceIn" />
            </div>

            <div className="space-y-2 border-2-b border-gray-300 md:border-0">
                <div className="flex flex-col justify-between items-start animate__animated animate__fadeInUp">
